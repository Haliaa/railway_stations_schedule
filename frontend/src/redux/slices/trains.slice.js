...
const {reducer:trainsReducer, actions:{createTrain, deleteTrainById, updateTrainById, setTrainForUpdate}} = trainsSlice;

const trainsActions = {
    getAll,create,deleteById,updateById, getById, setTrainForUpdate
}

export {
    trainsReducer, trainsActions
}
