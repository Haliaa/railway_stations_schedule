...
const getAll = createAsyncThunk("stationsSlice/getAll", async () => {
  const { data } = await stationsService.getAll();
  return data;
});
const getById = createAsyncThunk("stationsSlice/getById", async ({ id }) => {
...
export { stationsReducer, stationsActions };
